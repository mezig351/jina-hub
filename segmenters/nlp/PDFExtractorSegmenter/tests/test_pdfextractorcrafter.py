...
@pytest.mark.parametrize('inputs', [
    ...
    [[None, None], np.stack([input_bytes_images_text, input_bytes_images_text])],
])
...
@pytest.mark.parametrize('inputs', [
    ...
    [[None, None], np.stack([input_bytes_text, input_bytes_text])],
])
...
@pytest.mark.parametrize('inputs', [
    ...
    [[None, None], np.stack([input_bytes_image, input_bytes_image])],
])
